...
function Login() {
	...
	return (
		<div className="flex min-h-screen items-center justify-center bg-[#f5f5f2] p-4 font-[family-name:var(--sans)]">
			<div className="w-full max-w-md bg-[#fbfbf9] rounded-lg border border-[#d9d9d2] shadow-sm p-8">
				<div className="text-center mb-8">
					...
					<h2 className="text-2xl font-medium tracking-tight text-[#272724] mb-2">
						Welcome Back
					</h2>
				...
				{error && (
					<div className="bg-red-50 text-red-600 p-3 rounded text-xs mb-6 border border-red-200">
						{error}
					</div>
				)}
				...
				<div className="space-y-4">
					<button
						...
						disabled={loading}
						className="w-full flex items-center justify-center gap-3 bg-[#272724] hover:bg-[#1a1a18] text-[#fbfbf9] text-sm font-medium py-2.5 px-4 rounded transition-colors disabled:opacity-50 shadow-sm"
					>
						{loading ? (
