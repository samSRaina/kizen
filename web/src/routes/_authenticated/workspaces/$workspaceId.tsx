...
export const Route = createFileRoute("/_authenticated/workspaces/$workspaceId")(
	{
		// Use loader to fetch realtime data before rendering the route
		loader: async ({ params }) => {
			/*
      Example using openapi-fetch:
      const { data, error } = await apiClient.GET("/workspaces/{id}", {
        params: { path: { id: params.workspaceId } }
      });
    ...
    */
			return {
				...
				workspaceName: "Northwind Retail", // Mock from API
			};
		},
...
function WorkspaceBoard() {
	...
	const [workspaces, setWorkspaces] = useState([
		[loaderData.workspaceName, "23", "#6257d8"],
		...
		<div className="app-shell">
			<header className="app-topbar">
				...
				<div className="top-actions">
					...
					<button className="top-avatar" aria-label="User menu">
						<Avatar initials="JD" />
					</button>
				</div>
			</header>
				...
				<div className="content-main">
					<div className="page-title-row">
						...
						<div className="title-actions">
							...
							>
								<PlusIcon width={16} height={16} /> Create ticket
							</button>
						</div>
					</div>
					...
					<div className="board-toolbar">
						<div className="view-toggle">
							...
							>
								<ViewColumnsIcon width={15} height={15} /> Board
							</button>
							<button
								className={activeView === "list" ? "active" : ""}
								onClick={() => setActiveView("list")}
							>
								<ListBulletIcon width={15} height={15} /> List
							</button>
						</div>
			...
			<div className="status-bar">
				<span>
					<ChartBarIcon width={13} height={13} /> All systems operational
				</span>
